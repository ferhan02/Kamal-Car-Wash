(() => {
        ...
        return new Promise((resolve) => {
            ...
            overlay.innerHTML = `
                <div
                    ...
                    role="dialog"
                    aria-modal="true"
                    aria-labelledby="kcw-alert-title"
                >
                    <button
            ...
            overlay
                .querySelector('[data-kcw-confirm]')
                .addEventListener('click', () => finish(true), { once: true });

            overlay
                .querySelector('[data-kcw-cancel]')
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('[data-kcw-toast]').forEach((element) => {
            toast(
                element.dataset.kcwToast || element.textContent.trim(),
                {
        ...
        document.addEventListener('click', async (event) => {
            ...
            if (!element || element.dataset.kcwConfirmed === '1') {
                return;
            }
