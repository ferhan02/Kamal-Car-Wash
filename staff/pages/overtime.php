            ...
            <section class="ot-grid">
                <article class="ios-card request-card">
                    <div class="ios-card-header">
                        <h2>New request</h2>
                        <i class="fa-solid fa-plus" style="color:var(--staff-blue)">
                        </i>
                    </div>
                                            ...
                                            <?php foreach($history as $r): ?>
                                                <div class="history-item">
                                                    <div class="history-date">
                                                        <strong>
                                                            <?= date('d M',strtotime($r['overtime_date'])) ?>
                                                        </strong>
                                                        <span>
                                                            <?= number_format((float)$r['hours'],2) ?> h</span>
                                                        </div>
                                                        <div class="history-reason">
                                                            <strong>
                                                                <?= kcw_h($r['reason']?:'Overtime work') ?>
                                                            </strong>
