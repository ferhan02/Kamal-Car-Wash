...
<body class="staff-body">
    ...
    <main class="staff-main">
        <div class="staff-page-heading">
            <div>
                <span class="staff-eyebrow"><i class="fa-solid fa-hand-holding-dollar"></i> Payroll request</span>
                        ...
                        <?php foreach ($history as $r): ?>
                            <div class="advance-item">
                                <div class="advance-amount">
                                    ...
                                    <span><?= date('d M Y',strtotime($r['request_date'])) ?></span>
                                </div>
                                <div class="advance-reason">
                                    <strong><?= kcw_h($r['reason']) ?></strong>
