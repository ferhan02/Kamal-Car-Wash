...
<body class="staff-body">
    ...
    <main class="staff-main">
        <div class="staff-page-heading">
            <div>
                <span class="staff-eyebrow"><i class="fa-solid fa-calendar-xmark"></i> Approval queue</span>
        ...
        <section class="queue">
            ...
            <article class="ios-card request-card">
                ...
                <div class="request-meta">
                    ...
                    <span>
                        <i class="fa-solid fa-paper-plane"></i> Applied <?= date('d M Y',strtotime($r['apply_date'])) ?>
                    </span>
                </div>
                <?php if ($r['reason']): ?>
                    <p class="request-reason"><?= kcw_h($r['reason']) ?></p>
                <?php endif; ?>
