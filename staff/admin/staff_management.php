...
<body class="staff-body">
    ...
    <main class="staff-main">
        <div class="staff-page-heading">
            <div>
                <span class="staff-eyebrow"><i class="fa-solid fa-users-gear"></i> Administration</span>
            ...
            <a class="ios-btn ios-btn-primary" href="add_staff.php">
                <i class="fa-solid fa-user-plus"></i> Add staff</a>
        </div>
                        ...
                        <tr>
                            <td>
                                <div class="staff-person">
                                    ...
                                    <div>
                                        <strong><?= kcw_h($row['staff_name']) ?></strong>
                                        <span><?= kcw_h($row['staff_email']?:'No email') ?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="job-chip"><?= kcw_h($row['staff_job']) ?></span>
                            </td>
                            <td>
        ...
        <div class="mobile-staff">
            ...
            <article class="ios-card staff-card">
                ...
                <div class="staff-card-meta">
                    <div>Role<strong><?= kcw_h($row['staff_job']) ?></strong>
                    </div>
                    <div>Salary<strong>RM <?= number_format((float)$row['staff_salary'],2) ?>
                        </strong>
                    </div>
                    <div>State<strong><?= kcw_h($row['staff_state']) ?></strong>
                    </div>
                    <div>Phone<strong><?= kcw_h($row['staff_phonenum']) ?></strong>
                    </div>
                </div>
            </article>
        <?php endforeach; ?>
